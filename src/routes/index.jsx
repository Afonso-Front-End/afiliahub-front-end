...
export const Route = createFileRoute("/")({
    head: () => ({
        meta: [
            ...
            {
                name: "description",
                content: "Encontre as melhores ofertas da Shopee, Amazon, Mercado Livre, AliExpress e Magalu em um marketplace de afiliados moderno e curado.",
            },
...
function Index() {
    return (_jsxs(AppLayout, { children: [_jsx(Hero, {}), _jsx(Categories, {}), _jsx(FeaturedProducts, {}), _jsx(FlashDeals, {}), _jsx(CashbackSection, {})] }));
}
